...
public class ArvoreAVL {
	...
	private void setBalanceamento(No no) {
        ...
        No node = raiz;
        while (node != null) {
            System.out.print(node.getChave() + " "); // Exibe a chave no console
            if (node.getChave() == key) break;
            node = key > node.getChave() ? node.getDireita() : node.getEsquerda();
        }
        System.out.println();
        return node;
    }
        ...
        public boolean ehRaiz(int key){
         No node = raiz;
         if(key == node.getChave()){
             System.out.println("EH RAIZ");
             return true;
         }else{
             System.out.println("NAO EH RAI");
             return false;
         }          
        }
        ...
        private void printPreOrder(No node) {
        if (node == null) return;
        System.out.print(node.getChave() + " ");
        printPreOrder(node.getEsquerda());
        printPreOrder(node.getDireita());
    }
        ...
        private void printPostOrder(No node) {
        if (node == null) return;
        printPostOrder(node.getEsquerda());
       printPostOrder(node.getDireita());
        System.out.print(node.getChave() + " ");
    }
        ...
        if (node == null) return;
        printInOrder(node.getEsquerda());
        System.out.print(node.getChave() + " ");
        printInOrder(node.getDireita());
    }
